...
with st.container(border=True):
    ...
    info_col, _, status_col = st.columns([3, 2, 3], vertical_alignment="top")
    
    with info_col:
        st.markdown(f"<h1 style='margin-top:-30px'>{room}</h1>", unsafe_allow_html=True)
        st.write("Room Information bla bal bla")
